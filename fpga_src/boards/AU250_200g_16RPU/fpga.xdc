# XDC constraints for the Xilinx Alveo Au250 board
...
#####################################################
# From open-nic-shell Au250 design
set_property CONFIG_VOLTAGE 1.8 [current_design]
...
set_property -dict {LOC M11 } [get_ports qsfp0_mgt_refclk_1_p]  ;# 156MHz
set_property -dict {LOC M10 } [get_ports qsfp0_mgt_refclk_1_n]  ;# 156 MHz
...
set_property -dict {LOC T11} [get_ports qsfp1_mgt_refclk_1_p] ;# 156MHz
set_property -dict {LOC T10} [get_ports qsfp1_mgt_refclk_1_n] ;# 156MHz
